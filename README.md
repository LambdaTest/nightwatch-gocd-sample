# Run Selenium Tests with Nightwatch and GoCD on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Nightwatch Selenium tests integrated with GoCD CI/CD across real browsers and operating systems. This sample shows how to configure Nightwatch tests to run on the TestMu AI cloud with GoCD.
...
```bash
git clone https://github.com/LambdaTest/nightwatch-gocd-sample && cd nightwatch-gocd-sample
npm install
```
